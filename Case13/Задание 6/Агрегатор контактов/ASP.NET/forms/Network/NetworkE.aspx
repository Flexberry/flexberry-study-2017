...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="NetworkE.aspx.cs" Inherits="IIS.Агрегатор_контактов.NetworkE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Имзенение сети</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlsiteLabel" runat="server" Text="Сайт" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlsite" runat="server">
</asp:TextBox>
