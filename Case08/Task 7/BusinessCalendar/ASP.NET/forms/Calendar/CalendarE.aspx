...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Calendar</h2>
...
<div>
    ...
    <div class="clearfix">
        <asp:Label CssClass="descLbl" ID="ctrlBtnGoDaysLabel" runat="server" Text="Перейти к дням исключениям" EnableViewState="false">
        </asp:Label>
        <asp:Button ID="BtnGoDays" Text="Дни исключения" runat="server" OnClick="BtnGoDays_Click"/>
    </div>
</div>
<!-- autogenerated end -->
