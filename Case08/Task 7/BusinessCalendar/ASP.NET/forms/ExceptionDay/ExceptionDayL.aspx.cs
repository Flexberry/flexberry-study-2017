...
namespace IIS.BusinessCalendar
{
    ...
    public partial class ExceptionDayL : BaseListForm<ExceptionDay>
    {
        ...
        {
            ICSSoft.STORMNET.Web.Tools.PageContentManager.AttachExternalFile("/Controls/Calendar/JavaScript/jquery.CalendarView.js");
            ...
            ExceptionDayLimiter = ld.GetFunction(ld.funcEQ,
                                                new VariableDef(ld.GuidType, Information.ExtractPropertyPath<ExceptionDay>(e => e.Calendar)),
                                                Request["CalendarID"]);
        ...
        private void bindCalendarDataSource()
        {
            ...
            {
                LoadingCustomizationStruct lcs = LoadingCustomizationStruct.GetSimpleStruct(typeof(ExceptionDay), ExceptionDay.Views.ExceptionDayE);
                lcs.LimitFunction = ExceptionDayLimiter;
                List<ExceptionDay> exceptionDays = ds.LoadObjects(lcs).Cast<ExceptionDay>().ToList();
