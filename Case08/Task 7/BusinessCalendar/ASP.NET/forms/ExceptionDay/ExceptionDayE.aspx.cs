...
namespace IIS.BusinessCalendar
{
    ...
    public partial class ExceptionDayE : BaseEditForm<ExceptionDay>
    {
        ...
        protected override DataObject SaveObject()
        {
            ...
            {
                Calendar calendar = (Calendar)Session["CurrentCalendar"];
                this.DataObject.Calendar = calendar;
            } 

            ICSSoft.STORMNET.DataObject dataObject = base.SaveObject();
            return dataObject;
        }
