...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="WorkTimeDefinitionE.aspx.cs" Inherits="IIS.BusinessCalendar.WorkTimeDefinitionE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Определение рабочего времени</h2>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlSumTimeLabel" runat="server" Text="Сумма рабочего времения" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlSumTime" runat="server">
</asp:TextBox>
