    ...
    public partial class WeekE : BaseEditForm<Week>
    {
        ...
        protected override void PostApplyToControls()
        {
            ...
            if (!(sm.AccessObjectCheck(typeof(Week), tTypeAccess.Update, false) || sm.AccessObjectCheck(typeof(Week), tTypeAccess.Full, false)))
            {
                ...
                ctrlIsDefault.Enabled = false;
                ctrlMondayTS.ReadOnly = true;
                ctrlTuesdayTS.ReadOnly = true;
                ctrlWednesdayTS.ReadOnly = true;
                ctrlThursdayTS.ReadOnly = true;
                ctrlFridayTS.ReadOnly = true;
                ctrlSaturdayTS.ReadOnly = true;
                ctrlSundayTS.ReadOnly = true;
            }
            Page.Validate();
        }
