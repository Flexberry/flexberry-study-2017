...
namespace WebClientProject
{
    ...
    public partial class Calendar : System.Web.UI.Page
    {
        ...
        public Table CreateCalendar(DateTime startDate, DateTime finishDate)
        {
            ...
            List<Day> daysInformation = wtb.GetDaysCollection(startDate, finishDate);
            ...
            for (int rowNumber = 0; rowNumber < 5; rowNumber++)
            {
                ...
                for (int cellNumber = 0; cellNumber < 7; cellNumber++)
                {
                    ...
                    {
                        List<Day> currentDay = new List<Day>(daysInformation.Where<Day>(d => d.GetDate() == calendarStartDay));
