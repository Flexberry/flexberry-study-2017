...
namespace IIS.BusinessCalendar
{
    ...
    [View("Flexberry_WorkTimeSpanE", new string[] {
    ...
    public class WorkTimeSpan : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            /// <summary>
            /// "Flexberry_WorkTimeSpanE" view.
            /// </summary>
            public static ICSSoft.STORMNET.View Flexberry_WorkTimeSpanE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Flexberry_WorkTimeSpanE", typeof(IIS.BusinessCalendar.WorkTimeSpan));
                }
            }
        }
    }
