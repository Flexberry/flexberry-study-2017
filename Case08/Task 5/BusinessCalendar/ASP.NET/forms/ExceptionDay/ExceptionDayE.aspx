...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceptionDayE.aspx.cs" Inherits="IIS.BusinessCalendar.ExceptionDayE" %>
...
<head runat="server">
    <title></title>
    <link href="../../CSS/businessTimeSpans.css" rel="stylesheet" />
    <script src="../../shared/script/jquery-1.7.2.min.js" type="text/javascript"></script>
    <script src="../../shared/script/businessTimeSpans.js" type="text/javascript"></script>
    <script src="../../shared/script/exception-day-edit.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        ...
        <div class="<%= Constants.FormControlsCssClass %> <%= Constants.EditFormControlsCssClass %>">
            ...
            <div>
                ...
                <div class="businessTimeSpans"></div>
            </div>
            <!-- autogenerated end -->
