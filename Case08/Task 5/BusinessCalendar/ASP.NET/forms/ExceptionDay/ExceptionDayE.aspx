...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlWorkTimeDefinition_WorkTimeSpansLabel" runat="server" Text="WorkTimeDefinition.WorkTimeSpans" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlWorkTimeDefinition_WorkTimeSpans" runat="server" ReadOnly="true">
</asp:TextBox>
