        ...
        <div class="<%= Constants.FormControlsCssClass %> <%= Constants.EditFormControlsCssClass %>">
            ...
            <div>
                ...
                <asp:Literal ID="wtsLiteral" runat="server">
                    <input type="hidden" id="WtsJsonArray" value='{0}' />
                </asp:Literal>
                <table class="table table-bordered table-hover" id="TimeSpansTable">
                    <thead>
                        <tr class="colorStandart textMiddle">
                            <th class="textMiddle timeCell borderStandart">Время начала(чч:мм)</th>
                            <th class="textMiddle timeCell borderStandart">Время окончания(чч:мм)</th>
                            <th class="smallCell borderStandart"><button type="button" class="glyphiconStyle glyphicon-plus iconSmall background-center btnStandart btnSmall" id="btnAddTS" onclick="addRow('','','','');" ></button></th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
