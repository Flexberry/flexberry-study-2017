<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GetStudent.ascx.cs" Inherits="ICSSoft.STORMNET.Web.GetStudent" %>
...
<h2>Список студентов, которые выбрали первым приоритетом указанную организацию.</h2>
