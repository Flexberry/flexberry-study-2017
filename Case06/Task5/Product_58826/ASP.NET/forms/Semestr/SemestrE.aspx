...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SemestrE.aspx.cs" Inherits="IIS.Product_58826.СеместрE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНомерLabel" runat="server" Text="№ семестра" EnableViewState="False">
</asp:Label>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНачалоLabel" runat="server" Text="Начало" EnableViewState="False">
</asp:Label>
<div class="descTxt">
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКонецLabel" runat="server" Text="Конец" EnableViewState="False">
</asp:Label>
<div class="descTxt">
