...
namespace IIS.Product_58826
{
    ...
    public class ОрганизацияБС : ICSSoft.STORMNET.Business.BusinessServer
    {
        ...
        public virtual ICSSoft.STORMNET.DataObject[] OnUpdateОрганизация(IIS.Product_58826.Организация UpdatedObject)
        {
            ...
            var array = ((SQLDataService)DataService).Query<Организация>(Организация.Views.ОрганизацияE).Where(k => k.Название == UpdatedObject.Название).Where(k => k.Актуальность == true).ToArray();
