...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКоличествоПрограммLabel" runat="server" Text="Кол-во программ" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlКоличествоПрограмм" Type="Numeric" runat="server">
