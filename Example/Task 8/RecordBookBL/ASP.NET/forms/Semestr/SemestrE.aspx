...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SemestrE.aspx.cs" Inherits="NewPlatform.RecordBookBL.СеместрE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlОкончаниеLabel" runat="server" Text="Окончание" EnableViewState="False">
</asp:Label>
<div class="descTxt">
    <ac:DatePicker ID="ctrlОкончание" runat="server"/>
</div>
</div>
<div class="clearfix">
