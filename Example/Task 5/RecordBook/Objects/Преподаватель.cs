...
namespace NewPlatform.RecordBook
{
    ...
    [View("ПреподавательL", new string[] {
            ...
            "Логин as \'Логин\'",
            "ФИО as \'ФИО\'"})]
    public class Преподаватель : NewPlatform.RecordBook.Личность
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПреподавательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПреподавательE", typeof(NewPlatform.RecordBook.Преподаватель));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПреподавательL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПреподавательL", typeof(NewPlatform.RecordBook.Преподаватель));
                }
            }
        }
    }
