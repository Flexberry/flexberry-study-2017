...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SpecialnostE.aspx.cs" Inherits="NewPlatform.RecordBookBL.СпециальностьE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">СпециальностьE</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКодСпециальностиLabel" runat="server" Text="Код специальности" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlКодСпециальности" runat="server">
</asp:TextBox>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlГодНачалаПодготовкиLabel" runat="server" Text="Год начала подготовки" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlГодНачалаПодготовки" Type="Numeric" runat="server">
